...
straně polygonu určují okrajové podmínky, resp. uložení na této hraně (w=0?, \u03C6_n=0?). Např. kombinace okrajových podmínek [0,0] je pro volný okraj desky, [1,1] vetknutí, [0,1] podmínka osy symetrie, [1,0] válcový kloub.
